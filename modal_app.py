...
OCR_PIPELINE_WORKERS = int(os.getenv("EOSIN_MODAL_OCR_PIPELINE_WORKERS", "32"))
...
VLLM_GPU_MEMORY_UTILIZATION = os.getenv("EOSIN_MODAL_VLLM_GPU_MEMORY_UTILIZATION", "0.85")
VLLM_MAX_MODEL_LEN = os.getenv("EOSIN_MODAL_VLLM_MAX_MODEL_LEN", "16384")
VLLM_MAX_NUM_SEQS = os.getenv("EOSIN_MODAL_VLLM_MAX_NUM_SEQS", "32")
...
OCR_BACKEND_MODE = os.getenv("EOSIN_MODAL_BANK_PARSER_OCR_BACKEND_MODE", "page_http")
